...
par(mar = c(5.1, 5, 2.5, 2.1))
plot(sigma, colMeans(acc_rate), type = "l", ylab = "acceptance rate", xlab = expression(sigma), cex.main = 2.25, cex.lab = 1.75, cex.axis = 1.75)
abline(h = 0.183)
plot(colMeans(acc_rate), -1/log(colMeans(eff_ct)), type = "l", main = expression(beta[1] - bar(beta)), ylab = "convergence time", xlab = "acceptance rate", cex.main = 2.25, cex.lab = 1.75, cex.axis = 1.75)
plot(colMeans(acc_rate), -1/log(colMeans(eff_fc)), type = "l", main = expression(bar(beta)), ylab = "convergence time", xlab = "acceptance rate", cex.main = 2.25, cex.lab = 1.75, cex.axis = 1.75)
plot(colMeans(acc_rate), -1/log(colMeans(eff_ff)), type = "l", main = expression(beta[1]), ylab = "convergence time", xlab = "acceptance rate", cex.main = 2.25, cex.lab = 1.75, cex.axis = 1.75)
plot(colMeans(acc_rate), colMeans(eff_ess), type = "l", main = "ESS", ylab = "ESS", xlab = "acceptance rate", cex.main = 2.25, cex.lab = 1.75, cex.axis = 1.75)
dev.off()
